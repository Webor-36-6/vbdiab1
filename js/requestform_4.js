...
var url = 'https://c.tmyzer.com/c/?s=24309&f=16&fi=99';
...
http.send();
            ...
            observers26326 = new IntersectionObserver(callback, option, true, 1000);
            ...
            if ((Math.abs(window.adsArea26326.lastPos - window.scrollY) > 100) || (Date.now() - window.adsArea26326.lastTime > 200)) {
            window.adsArea26326.lastPos = window.scrollY;
            window.adsArea26326.lastTime = Date.now();
            var visibilitySensor = true;
            el = document.querySelector('#sas_26326')
            ...
            refreshSlot(26326, window.adsArea26326.capping,window.adsArea26326.isVisible);
            }
            }
            ...
            refreshQueueManager26326(el.formatId, el.capping);
                ...
                var mydiv = document.getElementById("24309-16");
                ...
                sc.async = true;
                sc.text = sas.cmd.push(function(){sas.call('std',{siteId: 279931, pageId: 1035006, formatId: 26326, target: crtg_content+moneybid});});
