...
var url = 'https://c.tmyzer.com/c/?s=24309&f=28&fi=99';
...
http.send();
            ...
            if ((window.adsArea30012.refreshTimer + el.refreshRate) < Date.now() && el.lastBidder.bidder !== slowBidder) {
            ...
            if (window.adsArea30012.refreshTimer + 25000 < Date.now() && el.lastBidder.bidder !== slowBidder) {
            refreshQueueManager30012(el.formatId, el.capping);
            } else if ((window.adsArea30012.refreshTimer + slowdown < Date.now() && el.lastBidder.bidder == slowBidder)) {
            refreshQueueManager30012(el.formatId, el.capping);
            }
            ...
            refreshQueueManager30012(el.formatId, el.capping);
                ...
                var mydiv = document.getElementById("24309-28");
