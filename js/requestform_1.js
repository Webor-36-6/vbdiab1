...
var url = 'https://c.tmyzer.com/c/?s=24309&f=6&fi=99';
...
http.send();
            ...
            refreshQueueManager26328(el.formatId, el.capping);
                ...
                var mydiv = document.getElementById("24309-6");
                ...
                sc.text = sas.cmd.push(function(){sas.call('std',{siteId: 279931, pageId: 1035006, formatId: 26328, target: crtg_content+moneybid});});
                creatediv.appendChild(sc);
                var http = new XMLHttpRequest();
                var url = 'https://c.tmyzer.com/c/?s=24309&f=6&fi=0';
                http.open("GET", url, true);
                http.send();
